...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Question
        fields = ['id', 'order', 'related_question', 'text', 'options', 'exam', 'solution', 'correct_option', 'language']
...
class ExamCenterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ExamCenter
        fields = ['id', 'center_name','phone', 'alt_phone', 'pincode', 'state', 'city', 'area', 'status', 'user']
...
class NewQuestionSerializer(serializers.ModelSerializer):
    ...
    def validate_text(self, value):
        # Removed uniqueness check to allow flexible question creation
        return value
...
class TeacherSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = [
            'id', 'Fname', 'Lname', 'email', 'profiles', 'is_active', 'is_verified',
