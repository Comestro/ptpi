...
MIDDLEWARE = [
    ...
    'teacherhire.middleware.GlobalExceptionLoggerMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'teacherhire', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'teacherhire.custom_exception_handler.custom_exception_handler',
...
USE_X_FORWARDED_HOST = True  # Use the proxy's Host header
